...
def generate_launch_description():
    ...
    object_spawner = IncludeLaunchDescription(
                PythonLaunchDescriptionSource([os.path.join(
                    get_package_share_directory('rrbot_description'), 'launch'), '/object_spawn.launch.py']))
    
    feature_extractor = IncludeLaunchDescription(
                PythonLaunchDescriptionSource([os.path.join(
                    get_package_share_directory('rrbot_gazebo'), 'launch'), '/feature_extractor.launch.py'])
             )
    
    image_controller = IncludeLaunchDescription(
                PythonLaunchDescriptionSource([os.path.join(
                    get_package_share_directory('rrbot_gazebo'), 'launch'), '/image_controller.launch.py'])
             )
    
    rrbot_controller = IncludeLaunchDescription(
                PythonLaunchDescriptionSource([os.path.join(
                    get_package_share_directory('rrbot_gazebo'), 'launch'), '/robot_controller.launch.py'])
             )
